  ...
  return (
    <main className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
      ...
      {agentProfile && (
        <div className="mt-6 mb-4 p-4 sm:p-6 bg-white rounded-lg shadow">
          <a href={`/agent/${agentProfile.id}`} className="flex items-center gap-3 sm:gap-4 cursor-pointer hover:bg-gray-50 p-3 sm:p-4 rounded">
            ...
            <div>
              <h3 className="text-base sm:text-lg lg:text-xl font-bold break-words">{agentProfile.full_name}</h3>
      ...
      <div className="mt-6">
        ...
        <p className="text-base sm:text-lg lg:text-xl font-semibold mt-2">
          {formattedPrice}
        </p>
          ...
          {!showTour && (
            <>
              ...
              <button
                ...
                className="w-full sm:w-auto bg-black text-white px-4 sm:px-6 py-2.5 sm:py-4 rounded-lg inline-flex items-center justify-center gap-2 text-sm sm:text-base"
              >
                <svg
      ...
      {videos.length > 0 && (
        ...
        <div className="mt-8 max-w-4xl mx-auto w-full">
          ...
          <h2 className="text-base sm:text-lg font-semibold mb-4 text-center md:text-left">
      ...
      <div className="mt-10">
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 gap-3">
          ...
          <button
            ...
            disabled={saving}
            className="w-full sm:w-auto bg-blue-600 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold hover:bg-blue-700 transition text-sm sm:text-base"
          >
          ...
          {phone ? (
            <button
              ...
              className="w-full sm:w-auto bg-green-600 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold hover:bg-green-700 transition text-sm sm:text-base"
            >
              Contact on WhatsApp
            </button>
          ) : (
